...
export type Basemap = 'positron' | 'dark-matter' | 'osm' | 'osm-transport' | 'osm-tracestrack-topo' | 'topo' | 'esri-street' | 'esri-topo' | 'esri-terrain' | 'esri-ocean' | 'esri-imagery' | 'google-maps' | 'google-terrain' | 'google-hybrid' | 'google-satellite'
